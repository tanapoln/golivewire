...
func init() {
	golivewire.RegisterFactory("tests.browser.querystring.component", func() interface{} {
	...
	golivewire.RegisterFactory("tests.browser.querystring.nestedcomponent", func() interface{} {
